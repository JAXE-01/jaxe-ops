...
CREATE TABLE IF NOT EXISTS reporting_metrics (
    ...
    couverture INT NULL DEFAULT NULL,
    vues INT NULL DEFAULT NULL,
    likes INT NULL DEFAULT NULL,
    commentaires INT NULL DEFAULT NULL,
    partages INT NULL DEFAULT NULL,
    clics INT NULL DEFAULT NULL,
    ctr DECIMAL(10,4) NULL,
    engagement_rate DECIMAL(10,4) NULL,
    avg_watch_time DECIMAL(10,4) NULL,
    sauvegardes INT NULL DEFAULT NULL,
    abonnes_gagnes INT NULL DEFAULT NULL,
