...
class PublicRegistrationService {
    ...
    public function register(array $input): array {
        ...
        try{
            ...
            if($type==='ClientCompany'){$stmt=$this->pdo->prepare("INSERT INTO clients(tenant_id,organization_id,relationship_mode,connected_at,nom,entreprise,email,statut) VALUES(:tenant,:org,'Connected',NOW(),:name,:company,:email,'Actif')");$stmt->execute(['tenant'=>$tenantId,'org'=>$organizationId,'name'=>$company,'company'=>$company,'email'=>$email]);}
