    ...
    public function index(){
        ...
        if($this->isPost()){
            ...
            try{
                ...
                }elseif($action==='reactivate'){$service->reactivate((int)($_POST['membership_id']??0));$this->flash('success','Accès restauré dans cette entreprise. Si le statut est Invité, renvoyez une invitation.');}elseif($action==='suspend'){$service->suspend((int)($_POST['membership_id']??0));$this->flash('success','Accès suspendu.');}
