...
<section class="panel content-overview" aria-label="Avancement de la fiche">
    ...
    <?php if(!empty($briefEditUrl)): ?><a class="button secondary" href="<?= htmlspecialchars($briefEditUrl) ?>">Continuer vers le <?= ($deliverable['type_livrable']??'')==='Video'?'script':'brief' ?> →</a><?php endif ?>
</section>
